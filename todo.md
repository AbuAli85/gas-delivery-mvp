...
- [x] التحقق من أن الاسم يتغير فعلياً عند تبديل اللغة
...
- [x] إضافة شريط تنقل سفلي (Bottom Navigation) للعميل يربط: الرئيسية / طلباتي / حسابي
- [x] التحقق من وجود زر رجوع واضح في جميع الصفحات الفرعية
